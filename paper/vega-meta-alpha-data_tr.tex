...
\title{VEGA META ALPHA DATA: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA META ALPHA DATA'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
